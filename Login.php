    ...
    <br>
        ...
        <section class="Formulario-1">
			<div class="Formulario-1-1"><!--Problemática 1:2. Formulário refere-se ao conjunto.(Login/senha)-->
				<h1 class="Titulo-1">Login</h1>
                <br>
                <form class="login_foma" method="POST" action="" name="form" onsubmit="validated()">
                
                    <select class="Input-3" name="NVLACS">
						<option value="Escolha" disabled selected>          Você é:</option>
						<option value="Masculino">Administrador</option>
						<option value="Feminino">Premium</option>
						<option value="Outro">Usuario</option>
					</select>
                    <br>
                    <br>
					<input class="Input1" name="email"  placeholder="Email do usúario:" required><!--Login-->
               
					<br>
                    
                    <br>

					<input class="Input2" type="password" name="senha" placeholder="Insira sua senha:" required><!--Senha-->
                        ...
                        if(isset($_POST['email']) || isset($_POST['senha'])) {
                            ...
                            if(strlen($_POST['email']) == 0) {
                                ...
                                if($quantidade == 1) {
                                    ...
                                    $_SESSION['nvlacs'] = $usuario['nvlacs'];
                    ...
                    ?>
                    <label class="lembrar">
                        <input type="checkbox" checked="checked" name="lembrar"> Lembrar-se de mim
                    </label>
					<br>
                    <br>
					<a class="Titulo-3" href="EsqueceuSenha3.html">Esqueceu a Senha? </a> 
                    <br>
					<button class="Botão" type="submit" onclick="logar() return false">Entrar</button></a> 
                    </form>
